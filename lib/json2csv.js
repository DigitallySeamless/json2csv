...
/**
 * Get JSON element by path, allows for nesting with fieldnames
 *
 * @param  {Mixed}  data_element - the JSON element to pull from
 * @param  {Array}  path         - the key/path for the JSON element
 * @param  {Number} position     - position in the path we are pulling
 * @return {String}              - the string respresentation of the element
 */
